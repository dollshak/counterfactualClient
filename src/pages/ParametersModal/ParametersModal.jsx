      ...
      <div className="modal_container">
        ...
        <div className="params_list">
          {algo.argument_lst.map((arg) => (
            <div 
            className={inputTypes[arg.param_name] &&
                        inputTypes[arg.param_name] === "dictionary"? "dictParam" : "param"} 
            key={arg.param_name}>
                      ...
                      inputTypes[arg.param_name] === "boolean" && (
                        <div>
                          <input
                            ...
                            onChange={(event) => onParamChange(event, arg)}
                          />
                          <label className="radioTxt" htmlFor="true">true</label>
                          <input
                            type="radio"
                            id="false"
                            value="false"
                            ...
                            onChange={(event) => onParamChange(event, arg)}
                          />-
                          <label className="radioTxt" htmlFor="false">false</label>
                        </div>
                      )}
              ...
              <div className="columnRight">
                <div className="defaultValueSubColumn">
                  <button className="defaultValButton"
